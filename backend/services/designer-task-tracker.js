...
Mensaje: "${text}"`
    ...
    console.error('Error parsing assignment:', error.message);
...
export async function markCorrection(taskId, pieceId, notes, imageUrl = null) {
  try {
    ...
    console.error('Error marking correction:', error.message);
    throw error;
  }
}
...
export async function deliverDesignPiece(taskId, pieceName, imageUrl = null) {
  try {
    ...
    console.error('Error delivering piece:', error.message);
    throw error;
  }
}
...
export async function getDesignerByPhone(phone) {
  try {
    ...
    console.error('Error finding designer by phone:', error.message);
    throw error;
  }
}
...
export async function getDesignerByName(name) {
  try {
    ...
    console.error('Error finding designer by name:', error.message);
    throw error;
  }
}
