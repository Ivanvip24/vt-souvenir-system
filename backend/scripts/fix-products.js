...
async function fixProducts() {
  try {
    ...
    await query(`
      ...
      ('Portarretratos de MDF', 'Portarretratos de MDF con corte láser personalizado. Marco decorativo para fotos con soporte trasero.', 40.00, 20.00, 14.00, 6.00, 'Souvenirs', 'https://res.cloudinary.com/dg1owvdhw/image/upload/v1771364794/products/portarretratos-mdf-axkan.png', 'https://res.cloudinary.com/dg1owvdhw/image/upload/v1771364794/products/portarretratos-mdf-axkan.png', 8, true),
