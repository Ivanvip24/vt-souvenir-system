...
async function fixProducts() {
  try {
    ...
    await query(`
      ...
      ('Imán de MDF con Foil', 'Imanes de MDF con acabado metálico de foil. Elegante y brillante.', 13.00, 3.50, 2.50, 1.00, 'Souvenirs Premium', 'https://vtanunciando.com/cdn/shop/files/IMAN-FOIL-MOCKUP---vtweb.png', 'https://vtanunciando.com/cdn/shop/files/IMAN-FOIL-MOCKUP---vtweb.png', 4, true),
