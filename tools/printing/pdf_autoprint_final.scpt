-- PDF Auto-Print Final Version
-- Restored exact working tray/paper settings, only changed scaling to 102.7%
...
on printPDF(filePath, copyCount)
	try
		-- EXACT SAME COMMAND AS WORKING VERSION, only changed scaling to 102.7% and added fit-to-page
		set shellCommand to "lp -d \"" & printerName & "\" -n " & copyCount & " -o page-ranges=1 -o InputSlot=Bypass -o scaling=105.3 -o orientation-requested=4 \"" & filePath & "\""
