-- PDF Auto-Print with Manual Settings (Fixed Syntax)
...
on printPDF(filePath, copyCount)
	try
		-- Use command line with your exact manual settings
		-- ADHESIVE paper: 330x480mm = 935x1360 points
		-- Bypass tray, 100.2% scaling, first page only
	...
	on error errMsg
		-- Fallback: Try with ADHESIVO preset name
		try
