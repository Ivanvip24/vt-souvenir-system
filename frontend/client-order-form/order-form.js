...
async function handleStripePayment() {
  ...
  // Show the "Ya pagué" button for Stripe
  const yaPagueStripe = document.getElementById('btn-ya-pague-stripe');
  if (yaPagueStripe) {
    yaPagueStripe.style.display = 'block';
  }

  // Update the pay button text to indicate they should come back
